package com.example.humbertina.mapa1;
...
public class MainActivity extends ActionBarActivity implements GoogleMap.OnMapClickListener {
    ...
    private final LatLng CASA = new LatLng(18.238095, -100.539591);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapa.addMarker(new MarkerOptions().position(CASA).title("CASA").snippet("Galeana oriente").icon(BitmapDescriptorFactory.fromResource(android.R.drawable.ic_menu_compass)).anchor(0.5f, 0.5f));
